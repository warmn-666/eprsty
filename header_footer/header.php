...
<html>
    <head>
        <title>Eprsty</title>
        <meta charset="utf-8">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> <!--Валидатор email -->
        <!--ЕСЛИ НЕ ЗНАЕШЬ, НЕ ТРОГАЙ -->
        ...
        <div id="auth_block">
            ...
            ?>
                    <div id="link_register">
                        <a href="/register/form_register.php">Регистрация</a>
                    </div>
